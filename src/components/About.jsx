...
const About = () => {
  ...
  return (
    <section className="bg-col py-16 px-8" id="about">
      <h2 className="text-4xl font-bold text-center mb-12 font-rounded text-blue-400">ABOUT ME!</h2>
      <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-20">
        <div className="relative flex-1 -top-16 max-w-[350px]">
        ...
        <div className="flex-1 min-w-[300px]">
          ...
          <h3 className="text-2xl font-bold mb-4 text-blue-400">Highlights:</h3>
